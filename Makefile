...
$(objdir)/mod_radiation.o: $(srcdir)/mod_radiation.f90 $(objdir)/mod_gas_optics_lut.o
$(objdir)/mod_model.o: $(srcdir)/mod_model.f90 $(objdir)/mod_sw_dyn.o $(objdir)/mod_radiation.o $(objdir)/mod_sync.o $(objdir)/mod_log.o $(objdir)/mod_input.o $(objdir)/mod_output.o $(objdir)/mod_timing.o
