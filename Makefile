...
$(objdir)/mod_io.o: $(srcdir)/mod_io.f90 $(objdir)/mod_netcdf.o
...
$(objdir)/mod_model.o: $(srcdir)/mod_model.f90 $(objdir)/mod_sw_dyn.o $(objdir)/mod_sync.o $(objdir)/mod_log.o $(objdir)/mod_io.o $(objdir)/mod_timing.o
